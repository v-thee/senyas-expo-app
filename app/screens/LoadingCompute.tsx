// app/screens/LoadingCompute.tsx
...
export default function LoadingCompute({ 
  onFinish, 
  message = "Computing Your Score",
  subMessage = "Analyzing your responses..."
}: Props) {
  ...
  useEffect(() => {
    ...
    // Score pulse animation (heartbeat-like)
    Animated.loop(
      Animated.sequence([
    ...
    const timer = setTimeout(onFinish, LOADING_DURATION_MS);
  ...
  const pulseScale = scorePulse.interpolate({
    inputRange: [0, 0.5, 1],
  ...
  return (
    <View style={styles.root}>
      ...
      <Animated.View style={[styles.tagWrap, { opacity: tagOpacity }]}>
        <Animated.Text style={[styles.tagline, { transform: [{ scale: pulseScale }] }]}>
          {message}
        </Animated.Text>
        
        <View style={styles.tagDivider} />
        
        <Text style={styles.tagSub}>{subMessage}</Text>
      ...
      <View style={styles.progressWrapper}>
        ...
        <View style={styles.dotsRow}>
          <Text style={styles.loadingLabel}>Calculating</Text>
